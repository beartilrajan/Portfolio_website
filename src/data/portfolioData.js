export const personalInfo = {
  name: "Beartil Rajan",
  role: "CS Engineer & Aspiring Tech Entrepreneur",
  positioning: "Computer Science Engineering student focused on building complete software applications, 3D web tools, and Python gesture interfaces while preparing to launch a tech startup.",
  bio: "I'm Beartil Rajan, a Computer Science Engineering student and aspiring product engineer and tech entrepreneur. My focus is on building complete software applications and eventually launching a startup. I balance daily classes with a strict development routine across WSL, Cursor, React, and Python, while documenting my journey through tech and dev vlogs.",
  location: "Open for Internships, Collaborations & Startup Ventures",
